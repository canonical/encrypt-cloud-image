...
func (b *encryptCloudImageBase) detectPartitions(rootPartitionUUID string, efiPartitionUUID string) error {
	...
	var root *gpt.PartitionEntry = nil
	...
	var esp *gpt.PartitionEntry = nil
	if (efiPartitionUUID != "") {

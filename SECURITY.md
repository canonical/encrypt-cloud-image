To report a security issue, file a [Private Security Report](https://github.com/canonical/encrypt-cloud-image/security/advisories/new) with a description of the issue,
